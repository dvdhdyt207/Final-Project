...
<body>
    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <h5 class="mb-4">Tabel Kriteria</h5>
            <a href="proses_maut.php" class="btn btn-success mb-3">Proses</a>
                    ...
                    <table class="table table-striped" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Kegiatan Pendahuluan</th> 
                                <th scope="col">Penguasaan Materi</th>
                                <th scope="col">Kualitas Pembelajaran</th>
                                <th scope="col">Penerapan Pengajaran</th>
                                <th scope="col">Evaluasi Pembelajaran</th>
                            </tr>
                        </thead>
                        <?php
                        include "..//insert_data/koneksi.php";
                        $no = 1;
                        $query = mysqli_query($kon, 'SELECT tbl_penilaian.*, tbl_guru.nama
                                                    FROM tbl_penilaian
                                                    JOIN tbl_guru ON tbl_penilaian.id_guru = tbl_guru.id_guru;');
