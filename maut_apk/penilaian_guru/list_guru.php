    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <div class="container mt-4">
                <h5 class="mb-4">Tabel Penilaian Guru</h5>
                    ...
                    <table class="table table-striped" style="width: 80%;">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href='form_penilaian.php?id_guru=<?php echo $data['id_guru'] ?>' class="btn btn-success btn-sm">Penilaian</a></td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>
