    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <div class="container mt-4">
                <h5 class="mb-4">Tabel Bobot</h5>
                <div class="table-responsive">
                    <table class="table table-striped" style="width: 40%;">
                        <thead>
                            <tr>
                                <th scope="col" style="width: 5%;">No</th>
                                <th scope="col" style="width: 20%;">Bobot</th>
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            $query = mysqli_query($kon, 'SELECT * FROM tbl_bobot');
                            while ($data = mysqli_fetch_array($query)) {
                            ?>
                                <tr>
                                    <td><?php echo $no++ ?></td>
                                    <td><?php echo $data['bobot'] ?></td>
                                    <td><?php echo $data['bbt'] ?></td>
                                    <td>
                                        <a href='bobot_update.php?id_b=<?php echo $data['id_b'] ?>' class="btn btn-warning btn-sm">Edit</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
